  ...
  return (
    <section className="py-20 px-6 relative">
      <div className="container mx-auto text-center relative z-10">
        <h2 className="text-5xl md:text-7xl font-bold mb-2 bg-foreground from-foreground via-foreground to-primary bg-clip-text text-transparent drop-shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
          {APP_NAME}
        </h2>
