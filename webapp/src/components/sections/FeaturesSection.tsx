import { Navigation, Package, Music, Radio as RadioIcon } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
    ...
    <section id="features" className="py-20 px-6 relative">
      ...
      <div className="container mx-auto relative">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
          <Card className="bg-gradient-to-b from-card to-secondary border-2 border-border transition-shadow">
            <CardHeader>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <CardDescription>"I need an extract, Shani!"</CardDescription>
                </div>
              </div>
            </CardHeader>
          </Card>
          ...
          <Card className="bg-gradient-to-b from-card to-secondary border-2 border-border transition-shadow">
            <CardHeader>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <CardTitle className="text-primary mb-2">Intel Hub</CardTitle>
                  <CardDescription>
