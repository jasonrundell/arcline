...
export const BioSection = () => {
  ...
  return (
    <Section id="project" paddingY="md">
      <div className="flex flex-col sm:flex-row max-w-4xl mx-auto gap-8">
        <div className="flex flex-col items-center justify-center sm:w-1/3">
          ...
          <a
            ...
            className={linkClasses}
          >
            <span className="inline-block w-5 h-5 mr-1" aria-hidden="true">
        ...
        <div className="flex flex-col space-y-4 sm:w-2/3">
          <div className="space-y-4">
            <h4 className="text-lg font-bold">Who&apos;s Jason?</h4>
            <p>
              Jason is a full stack developer with a passion for building web
              applications. You can learn more about Jason and his work at{" "}
              <a
            ...
            <h4 className="text-lg font-bold">What inspired this project?</h4>
            <p>
              The video game{" "}
              <a
            ...
            <h4 className="text-lg font-bold">About this project</h4>
            <p>
            ...
            <ul className="list-disc list-inside">
              ...
              <li className="ml-4">
                <strong>Web app:</strong> the frontend is what you're looking at
                right now
              </li>
            </ul>
            <p>
